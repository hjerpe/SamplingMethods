...
inverse_method <- function(n_samples, F_inverse) {
    # Returns n_samples of a random variable having the distribution function
    # F.

    # ARGS:
    # n_samples - Number of drawn samples
    # F_inverse - Inverse function of the desired sampling distribution F
...
inverse_exponential <- function(x) -log(1 - x)

# Illustrate drawn samples having exp(1) distributions using the inverse
# method
N_SAMPLES = 10000
exponential_samples <- inverse_method(N_SAMPLES, inverse_exponential)
